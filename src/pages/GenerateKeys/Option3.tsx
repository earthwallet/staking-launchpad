    ...
    <div className="mt30">
      ...
      <Text>
        ...
        <Link
          ...
          primary
          isTextLink={false}
          to="https://github.com/earthwallet/staking-deposit-cli/archive/master.zip"
        >
          <Button
            className="my20"
            label={formatMessage({
            ...
            values={{
              gitClone: (
                <Code>
                  ...
                  https://github.com/earthwallet/staking-deposit-cli.git
                </Code>
              ),
      ...
      <Text className="my20">
        ...
        <Link
          primary
          inline
          to="https://github.com/earthwallet/staking-deposit-cli"
        >
          https://github.com/earthwallet/staking-deposit-cli
        </Link>
      </Text>
    </div>
  );
